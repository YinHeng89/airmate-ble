...
exports.transition = function(n) {
  return Behavior({
    ...
    methods: {
      ...
      enter: function() {
        var n = this;
        this.enterFinishedPromise || (this.enterFinishedPromise = new Promise((function(i) {
          var s = n.data,
            r = s.duration,
            o = s.name,
            c = a(o),
            v = (0, t.isObj)(r) ? r.enter : r;
          "enter" !== n.status && (n.status = "enter", n.$emit("before-enter"), (0, e.requestAnimationFrame)((function() {
      ...
      leave: function() {
        var n = this;
        this.enterFinishedPromise && this.enterFinishedPromise.then((function() {
          if (n.data.display) {
            var i = n.data,
              s = i.duration,
              r = i.name,
              o = a(r),
              c = (0, t.isObj)(s) ? s.leave : s;
            n.status = "leave", n.$emit("before-leave"), (0, e.requestAnimationFrame)((function() {
              "leave" === n.status && (n.$emit("leave"), n.setData({
                classes: o.leave,
                currentDuration: c
              }), (0, e.requestAnimationFrame)((function() {
                "leave" === n.status && (n.transitionEnded = !1, setTimeout((function() {
                  n.onTransitionEnd(), n.enterFinishedPromise = null
                }), c), n.setData({
                  classes: o["leave-to"]
                }))
              })))
