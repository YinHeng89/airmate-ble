module.exports = {
  protocolJson: [{
    ...
    protocol: [{
      key: "open",
      value: "55 AA 01 B3 B4 A5"
    }, {
      key: "close",
      value: "55 AA 01 BB BC A5"
    }]
  }, {
    id: "111",
    type: "mode",
    ...
    protocol: [{
      key: "open",
      value: "55 AA 01 B4 B5 A5"
    }, {
      key: "close",
      value: "55 AA 01 BC BD A5"
    }]
  }, {
    id: "112",
    type: "mode",
    ...
    protocol: [{
      key: "open",
      value: "55 AA 01 B5 B6 A5"
    }, {
      key: "close",
      value: "55 AA 01 BD BE A5"
    }]
  }, {
    id: "113",
    type: "mode",
    ...
    protocol: [{
      key: "open",
      value: "55 AA 01 B6 B7 A5"
    }, {
      key: "close",
      value: "55 AA 01 BE BF A5"
    }]
  }, {
    id: "114",
    type: "mode",
    ...
    protocol: [{
      key: "open",
      value: "55 AA 01 B7 B8 A5"
    }, {
      key: "close",
      value: "55 AA 01 BF C0 A5"
    }]
  }, {
    id: "115",
    type: "mode",
  ...
  attributeRules: [{
    ...
    children: [{
      type: "direct",
      position: "0",
      path: "mode.灯光模式.hongdeng"
    }, {
      type: "direct",
      position: "1",
      path: "mode.灯光模式.chengdeng"
    }, {
      type: "direct",
      position: "2",
      path: "mode.灯光模式.huangdeng"
    }, {
      type: "direct",
      position: "3",
      path: "mode.灯光模式.lvdeng"
    }, {
      type: "direct",
      position: "4",
      path: "mode.灯光模式.landeng"
    }, {
      type: "direct",
      position: "5",
      path: "mode.灯光模式.zideng"
    }, {
      type: "direct",
      position: "6",
      path: "mode.灯光模式.baideng"
    }, {
      type: "direct",
      position: "7",
      path: "mode.灯光模式.zidong"
    }]
  }],
  specialJson: [{
    type: "initial",
  ...
  commandWords: {
    ...
    "灯光模式": ["打开红灯|关闭红灯", "打开橙灯|关闭橙灯", "打开黄灯|关闭黄灯", "打开绿灯|关闭绿灯", "打开蓝灯|关闭蓝灯", "打开紫灯|关闭紫灯", "打开白灯|关闭白灯", "打开氛围灯|关闭氛围灯"],
