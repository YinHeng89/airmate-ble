module.exports = {
  ...
  styleConfig: {
    themeColor: "#239C8E",
    slider: {
      activeColor: "rgba(35,156,142,0.4)",
  ...
  protocolJson: [{
    ...
    displayName: "正常风",
    isMutex: !0,
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_zhengchangfeng_on.svg",
    icon_off: "/V2/image/fan/icon_zhengchangfeng_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_ziranfeng_on.svg",
    icon_off: "/V2/image/fan/icon_ziranfeng_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_xunhuanfeng_on.svg",
    icon_off: "/V2/image/fan/icon_xunhuanfeng_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_zhinengfeng_on.svg",
    icon_off: "/V2/image/fan/icon_zhinengfeng_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_yingerfeng_on.svg",
    icon_off: "/V2/image/fan/icon_yingerfeng_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_jingyin_on.svg",
    icon_off: "/V2/image/fan/icon_jingyin_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_baofeng_on.svg",
    icon_off: "/V2/image/fan/icon_baofeng_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_pingxian_on.svg",
    icon_off: "/V2/image/fan/icon_pingxian_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_dengguang_on.svg",
    icon_off: "/V2/image/fan/icon_dengguang_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_jiashi_on.svg",
    icon_off: "/V2/image/fan/icon_jiashi_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_lenfeng_on.svg",
    icon_off: "/V2/image/fan/icon_lenfeng_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_quwen_on_s.svg",
    icon_off: "/V2/image/fan/icon_quwen_off.svg",
    protocol: [{
      key: "open",
    ...
    icon_bg_on: "/V2/image/fan/icon_green_btn_on.svg",
    icon_bg_off: "/V2/image/fan/icon_btn_off.svg",
    icon_on: "/V2/image/fan/icon_qujiaquan_on.svg",
    icon_off: "/V2/image/fan/icon_qujiaquan_off.svg",
    protocol: [{
      key: "open",
  ...
  attributeRules: [{
    ...
    children: [{
      type: "direct",
      position: "0",
      path: "iconMode.其他模式.童锁"
    }, {
      type: "direct",
      position: "1",
      path: "iconMode.其他模式.负离子"
    }, {
      type: "direct",
      position: "2",
      path: "iconMode.其他模式.屏显"
    }, {
      type: "direct",
      position: "3",
      path: "iconMode.其他模式.灯光"
    }, {
      type: "direct",
      position: "4",
      path: "iconMode.其他模式.加湿"
    }, {
      type: "direct",
      position: "5",
      path: "iconMode.其他模式.冷风"
    }, {
      type: "direct",
      position: "6",
      path: "iconMode.其他模式.驱蚊"
    }, {
      type: "direct",
      position: "7",
      path: "iconMode.其他模式.去甲醛"
    }]
  }, {
    type: "direct",
    position: "6",
    ...
    children: [{
      type: "direct",
      position: "0",
      path: "iconMode.运行模式.正常风"
    }, {
      type: "direct",
      position: "1",
      path: "iconMode.运行模式.自然风"
    }, {
      type: "direct",
      position: "2",
      path: "iconMode.运行模式.睡眠风"
    }, {
      type: "direct",
      position: "3",
      path: "iconMode.运行模式.循环风"
    }, {
      type: "direct",
      position: "4",
      path: "iconMode.运行模式.智能风"
    }, {
      type: "direct",
      position: "5",
      path: "iconMode.运行模式.婴儿风"
    }, {
      type: "direct",
      position: "6",
      path: "iconMode.运行模式.静音"
    }, {
      type: "direct",
      position: "7",
      path: "iconMode.运行模式.暴风"
    }]
  }, {
    type: "bit",
    position: "9",
    children: [{
      type: "direct",
      position: "0",
      path: "iconMode.其他模式.摇头"
    }, {
      type: "direct",
      position: "1",
      path: "iconMode.其他模式.左右摇头"
    }, {
      type: "direct",
      position: "3",
      path: "iconMode.其他模式.上下摇头"
    }]
  }, {
    type: "bit",
    position: "10",
  ...
  commandWords: {
    show: {
      ...
      "定时": ["关闭定时|取消定时", "定时X小时"],
      "预约": ["关闭预约|取消预约", "预约X小时"],
      "摇头": ["打开摇头", "关闭摇头", "打开左右摇头|左右摇头", "关闭左右摇头", "打开上下摇头|上下摇头", "关闭上下摇头"],
      "运行模式": ["正常风", "关闭正常风", "自然风", "关闭正常风", "睡眠风", "关闭睡眠风", "循环风", "关闭循环风", "智能风", "关闭智能风"],
      "其他模式": ["打开童锁", "关闭童锁", "打开负离子", "关闭负离子", "打开显示|打开屏显", "关闭显示|关闭屏显", "打开灯光", "关闭灯光", "打开加湿", "关闭加湿", "打开冷风", "关闭冷风", "婴儿风模式", "关闭婴儿风模式", "静音模式", "关闭静音模式", "暴风模式", "关闭暴风模式", "打开驱蚊", "关闭驱蚊", "打开去甲醛", "关闭去甲醛", "打开暖光", "关闭暖光"],
      "风量": ["调大风量|风大点", "调小风量|风小点"],
