module.exports = {
  ...
  attributeRules: [{
    ...
    children: [{
      ...
      type: "direct",
      position: "1",
      path: "mode.摇头.leftYaotou"
    }, {
      type: "direct",
      position: "2",
      path: "mode.摇头.upYaotou"
    }, {
      type: "direct",
      position: "3",
      path: "mode.摇头.baiye"
    ...
    children: [{
      ...
      type: "direct",
      position: "3",
      path: "mode.模式.xianshi"
    }, {
      type: "direct",
      position: "4",
      path: "mode.模式.dengguang"
    }, {
      type: "direct",
      position: "5",
      path: "mode.模式.wuhua"
    ...
    children: [{
      ...
      type: "direct",
      position: "3",
      path: "mode.能效.jieneng"
    }, {
      type: "direct",
      position: "4",
      path: "mode.能效.zhineng"
    }, {
      type: "direct",
      position: "5",
    ...
    children: [{
      type: "direct",
      position: "0",
      path: "modeExclude.加热档位.yidang"
    }, {
      type: "direct",
      position: "1",
      path: "modeExclude.加热档位.erdang"
    }, {
      type: "direct",
      position: "2",
      path: "modeExclude.加热档位.sandang"
    }, {
      type: "direct",
      position: "3",
      path: "modeExclude.加热档位.sidang"
    }, {
      type: "direct",
      position: "4",
      path: "modeExclude.加热档位.wudang"
    }]
  }],
  specialJson: [{
    type: "initial",
  ...
  commandWords: {
    "唤醒词": ["小爱小爱"],
    "开关": ["打开取暖器|开机", "关闭取暖器|关机"],
    "温度设置": ["设置X度"],
    "档位": ["调到一档", "调到二档", "调到三档", "调到四档", "调到五档", "关闭加热", "打开底部取暖", "关闭底部取暖"],
    "定时": ["关闭定时|取消定时", "定时X小时"],
    "预约": ["关闭预约|取消预约", "预约X小时"],
    "摇头": ["打开左右摇头", "关闭左右摇头", "打开上下摇头", "关闭上下摇头", "打开摇头", "关闭摇头", "打开摆叶", "关闭摆叶"],
    "模式": ["开启冷风|打开冷风|冷风模式", "开启低热|打开低热|低热模式", "打开高热|开启高热|高热模式", "节能模式|打开节能", "关闭节能模式", "智能模式|打开智能", "关闭智能模式", "打开负离子", "关闭负离子", "打开童锁", "关闭童锁", "打开火焰", "关闭火焰", "打开显示", "关闭显示", "打开灯光", "关闭灯光", "打开雾化|打开加湿", "关闭雾化|关闭加湿"],
    "音量调节": ["增大音量|音量增大", "减小音量|音量减小", "音量最大|最大音量", "音量最小|最小音量", "中等音量"],
