module.exports = {
  protocolJson: [{
    ...
    commandWords: ["打开冷风", "关闭冷风"]
  }, {
    id: "4",
    type: "mode",
    label: "档位",
    displayName: "一档暖风",
    value: "yidangnuanfeng",
    protocol: [{
      key: "open",
    ...
    commandWords: ["一档加热", "调到一档"]
  }, {
    id: "5",
    type: "mode",
    label: "档位",
    displayName: "二档暖风",
    value: "erdangnuanfeng",
    protocol: [{
      key: "open",
    ...
    protocol: [{
      key: "open",
      value: "AA 01 12 01 55"
    }, {
      key: "close",
      value: "AA 01 12 00 55"
    }],
    commandWords: ["打开壁炉", "关闭壁炉"]
  }, {
    id: "86",
    type: "special",
    label: "环境温度"
  ...
  initialRules: [{
    ...
    type: "min",
    position: "6",
    associatedIds: [60, 61, 62, 63, 64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80]
  }, {
    type: "max",
    position: "7",
    associatedIds: [60, 61, 62, 63, 64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80]
  ...
  attributeRules: [{
    ...
    children: [{
      ...
      type: "direct",
      position: "1",
      path: "mode.档位.yidangnuanfeng"
    }, {
      type: "direct",
      position: "2",
      path: "mode.档位.erdangnuanfeng"
    }, {
      type: "direct",
      position: "3",
