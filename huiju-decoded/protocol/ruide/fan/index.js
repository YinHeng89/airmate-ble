var e = require("../../../@babel/runtime/helpers/objectSpread2")({
  show: {
    ...
    "定时": ["关闭定时|取消定时", "定时X小时"],
    "预约": ["关闭预约|取消预约", "预约X小时"],
    "摇头": ["打开摇头", "关闭摇头", "打开左右摆头|左右摆头", "关闭左右摆头", "打开上下摇头|上下摇头", "关闭上下摇头"],
...
}, require("./commandWords").fanCommandWords);
module.exports = {
  protocolJson: [{
    id: "1",
    type: "mainSwitch",
    ...
    protocol: [{
      key: "open",
      value: "55 AA 01 F8 F9 A5"
    }, {
      key: "close",
      value: "55 AA 01 F9 FA A5"
    }]
  }, {
    id: "1091",
    type: "bofeiFanYaoTou",
    ...
    type: "bofeiFanYaoTou",
    label: "风随人动",
    value: "fengsuirendong",
    protocol: [{
      key: "open",
      value: "55 AA 02 C1 C3 A5"
    }, {
      key: "close",
      value: "55 AA 02 C0 C2 A5"
    }]
  }, {
    id: "1101",
    type: "bofeiFanYaoTou",
    ...
    label: "左右摆头",
    displayName: "60度",
    value: "zuoyouyaotou60",
    protocol: [{
      key: "open",
      value: "55 AA 02 B1 B3 A5"
    }, {
      key: "close",
      value: "55 AA 02 B6 B8 A5"
    }]
  }, {
    id: "942",
    type: "bofeiFanYaoTou",
    ...
    label: "左右摆头",
    displayName: "90度",
    value: "zuoyouyaotou90",
    protocol: [{
      key: "open",
      value: "55 AA 02 B2 B4 A5"
    }, {
      key: "close",
      value: "55 AA 02 B7 B9 A5"
    }]
  }, {
    id: "943",
    type: "bofeiFanYaoTou",
    ...
    label: "左右摆头",
    displayName: "120度",
    value: "zuoyouyaotou120",
    protocol: [{
      key: "open",
      value: "55 AA 02 B3 B5 A5"
    }, {
      key: "close",
      value: "55 AA 02 B8 BA A5"
    }]
  }, {
    id: "944",
    type: "bofeiFanYaoTou",
    ...
    label: "左右摆头",
    displayName: "180度",
    value: "zuoyouyaotou180",
    protocol: [{
      key: "open",
      value: "55 AA 02 B4 B6 A5"
    }, {
      key: "close",
      value: "55 AA 02 B9 BB A5"
    }]
  }, {
    id: "945",
    type: "bofeiFanYaoTou",
    ...
    label: "左右摆头",
    displayName: "360度",
    value: "zuoyouyaotou360",
    protocol: [{
      key: "open",
      value: "55 AA 02 B5 B7 A5"
    }, {
      key: "close",
      value: "55 AA 02 BA BC A5"
    }]
  }, {
    id: "95",
    type: "bofeiFanYaoTou",
    ...
    label: "上下摆头",
    displayName: "90度",
    value: "shangxiayaotou90",
    protocol: [{
      key: "open",
      value: "55 AA 02 BB BD A5"
    }]
  }, {
    id: "952",
    type: "bofeiFanYaoTou",
    ...
    label: "上下摆头",
    displayName: "180度",
    value: "shangxiayaotou180",
    protocol: [{
      key: "open",
      value: "55 AA 02 BC BE A5"
    }]
  }, {
    id: "38",
    type: "counter",
    ...
    protocol: [{
      key: "open",
      value: "55 AA 02 94 95 A5"
    }, {
      key: "close",
      value: "55 AA 02 95 96 A5"
    }]
  }, {
    id: "98",
    type: "mode",
    ...
    type: "switch",
    label: "手势控制",
    value: "shoushikongzhi",
    protocol: [{
      key: "open",
      value: "55 AA 02 C5 C7 A5"
    }, {
      key: "close",
      value: "55 AA 02 C4 C6 A5"
    }]
  }],
  initialRules: [{
    type: "initialMark",
  ...
  attributeRules: [{
    ...
    children: [{
      ...
      type: "direct",
      position: "5",
      path: "bofeiFanYaoTou.风随人动.status"
    }, {
      type: "direct",
      position: "6",
      path: "switch.驱蚊.quwen"
    }, {
      type: "direct",
      position: "7",
    ...
    children: [{
      type: "direct",
      position: "0",
      path: "modeExclude.风模式.normal"
    }, {
      type: "direct",
      position: "1",
      path: "bofeiFanYaoTou.自然风.status"
    }, {
      type: "direct",
      position: "2",
      ...
      type: "direct",
      position: "3",
      path: "modeExclude.风模式.loop"
    }, {
      type: "direct",
      position: "4",
      path: "modeExclude.风模式.intelligence"
    }, {
      type: "direct",
      position: "5",
      path: "modeExclude.风模式.yingerfeng"
    }, {
      type: "direct",
      position: "6",
      path: "modeExclude.风模式.jingyin"
    }, {
      type: "direct",
      position: "7",
      path: "modeExclude.风模式.baofeng"
    }]
  }, {
    type: "bit",
    position: "9",
    children: [{
      ...
      type: "direct",
      position: "1",
      path: "bofeiFanYaoTou.左右摆头.status"
    }, {
      type: "direct",
      position: "2",
      path: "bofeiFanYaoTou.空调风.status"
    }, {
      type: "direct",
      position: "3",
      path: "bofeiFanYaoTou.上下摆头.status"
    }, {
      type: "direct",
      position: "6",
      path: "bofeiFanYaoTou.左右摆头.children.zuoyouyaotou360"
    }, {
      type: "direct",
      position: "7",
      path: "switch.手势控制.shoushikongzhi"
    }]
  }, {
    type: "value",
    position: "9",
    ...
    detail: [{
      value: "1",
      path: "bofeiFanYaoTou.空调风.children.yidang"
    }, {
      value: "2",
      path: "bofeiFanYaoTou.空调风.children.erdang"
    }]
  }, {
    type: "bit",
    position: "10",
    children: [{
      ...
      type: "direct",
      position: "1",
      path: "bofeiFanYaoTou.自然风.children.yidang"
    }, {
      type: "direct",
      position: "2",
      path: "bofeiFanYaoTou.自然风.children.erdang"
    }, {
      type: "direct",
      position: "3",
      path: "bofeiFanYaoTou.自然风.children.sandang"
    }, {
      type: "direct",
      position: "4",
      path: "bofeiFanYaoTou.左右摆头.children.zuoyouyaotou60"
    }, {
      type: "direct",
      position: "5",
      path: "bofeiFanYaoTou.左右摆头.children.zuoyouyaotou90"
    }, {
      type: "direct",
      position: "6",
      path: "bofeiFanYaoTou.左右摆头.children.zuoyouyaotou120"
    }, {
      type: "direct",
      position: "7",
      path: "bofeiFanYaoTou.左右摆头.children.zuoyouyaotou180"
    }]
  }, {
    type: "value",
    position: "11",
    ...
    detail: [{
      value: "1",
      path: "bofeiFanYaoTou.睡眠风.children.yidang"
    }, {
      value: "2",
      path: "bofeiFanYaoTou.睡眠风.children.erdang"
    }]
  }, {
    type: "value",
    position: "11",
    ...
    detail: [{
      value: "1",
      path: "bofeiFanYaoTou.风随人动.children.danren"
    }, {
      value: "2",
      path: "bofeiFanYaoTou.风随人动.children.duoren"
    }]
  }, {
    type: "bit",
    position: "11",
    children: [{
      type: "direct",
      position: "4",
      path: "bofeiFanYaoTou.上下摆头.children.shangxiayaotou90"
    }, {
      type: "direct",
      position: "5",
      path: "bofeiFanYaoTou.上下摆头.children.shangxiayaotou180"
    }, {
      type: "direct",
      position: "6",
      path: "mode.特殊模式.denglizi"
    }]
  }],
  specialJson: [{
    type: "initial",
